...
async function startChat() {
    ...
    // drip: サーバーがわざとゆっくり（2秒かけて）、30個の「*」を送ってくるURL
    // ※本当のAIは言葉を送りますが、実験なので「*」で代用します
    const response = await fetch("https://httpbin.org/drip?duration=2&numbytes=30&code=200&delay=0");
